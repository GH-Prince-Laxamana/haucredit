      ...
      <section class="content about-page">
        <div class="about-hero">
          ...
          <p>
            ...
            is a comprehensive web-based event compliance tracking system designed specifically for Holy Angel
        ...
        <div class="about-section">
          ...
          <ul class="feature-list">
            <li></span> <strong>Smart Event Classification</strong> - Automatically determines required documents based
              on activity type</li>
          ...
          <div class="about-grid">
            <article class="about-card">
              ...
              <div class="about-body">
                ...
                <p>Responsible for planning the database schema, creating the database and tables, defining
                  relationships, connecting forms to the database, implementing login and logout with session
                  management, and developing CRUD operations and search functionality using PHP and SQL.</p>
              </div>
            </article>
            ...
            <article class="about-card">
              ...
              <div class="about-body">
                ...
                <p>Responsible for creating the wireframes, defining the site structure, layouts, and navigation flow,
                  designing the overall user interface reference, and implementing the responsive layout and navigation
                  menu using HTML and CSS</p>
              </div>
            </article>
            ...
            <article class="about-card">
              ...
              <div class="about-body">
                ...
                <p>Responsible for contributing to the wireframing and layout planning of the website, helping define
                  the overall structure and visual flow of the pages, designing the dashboard and other site pages,
                  applying basic styling and responsiveness, and coding the static pages using HTML and CSS.</p>
              </div>
            </article>
            ...
            <article class="about-card">
              ...
              <div class="about-body">
                ...
                <p>Designing the event input form, search, and login forms by carefully structuring and organizing
                  fields to ensure clarity, accessibility, and ease of use, improving the overall user experience
                  through logical grouping and intuitive layout. </p>
              </div>
            </article>
          </div>
        </div>
